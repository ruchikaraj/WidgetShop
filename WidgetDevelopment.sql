...
USE tempdb
go
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'WidgetDevelopment')
BEGIN
	ALTER DATABASE [WidgetDevelopment] SET  SINGLE_USER WITH ROLLBACK IMMEDIATE
    DROP DATABASE WidgetDevelopment
    END

--Create the databases and structure
CREATE DATABASE WidgetDevelopment
GO
USE WidgetDevelopment
GO
/* required to ensure that if the DB was created with a windows login the trustworthy doesn't fail*/
ALTER AUTHORIZATION ON DATABASE::WidgetDevelopment TO sa
GO
ALTER DATABASE WidgetDevelopment SET TRUSTWORTHY ON -- For tSQLt also need:EXEC sp_configure 'clr enabled', 1
GO
RECONFIGURE
...
INSERT INTO [dbo].[Widgets] ([RecordID], [Description], [SKU]) VALUES (1, 'Red widget', 'RW')
INSERT INTO [dbo].[Widgets] ([RecordID], [Description], [SKU]) VALUES (2, 'Extended widget2', 'EW')
INSERT INTO [dbo].[Widgets] ([RecordID], [Description], [SKU]) VALUES (4, 'Grow-your-own widget', 'GW')
INSERT INTO [dbo].[Widgets] ([RecordID], [Description], [SKU]) VALUES (5, 'Widget access kit', 'AW')
INSERT INTO [dbo].[Widgets] ([RecordID], [Description], [SKU]) VALUES (6, 'Test kit', 'TK')
INSERT INTO [dbo].[Widgets] ([RecordID], [Description], [SKU]) VALUES (7, 'Exploded widget diagram', 'ED')
...
INSERT INTO [dbo].[Contacts] ([ID], [ContactFullName], [PhoneWork], [PhoneMobile], [Address1], [Address2], [Address3], [JoiningDate], [Email]) VALUES (1, N'Christopher Martin', N'01446 175923', N'07634 717173', N'17 High Street', N'Darlington', N'Cheshire', '20070914 16:09:21.383', N'Christopher.Martin@example.com')
INSERT INTO [dbo].[Contacts] ([ID], [ContactFullName], [PhoneWork], [PhoneMobile], [Address1], [Address2], [Address3], [JoiningDate], [Email]) VALUES (2, N'Joseph Bennett', N'01147 771824', N'07956 758471', N'37 Green Lane', N'Portsmouth', N'County Durham', '20070914 16:09:21.400', N'Joseph.Bennett@example.com')
INSERT INTO [dbo].[Contacts] ([ID], [ContactFullName], [PhoneWork], [PhoneMobile], [Address1], [Address2], [Address3], [JoiningDate], [Email]) VALUES (3, N'Joshua Scott', N'01940 919059', N'07331 757163', N'33 George Street', N'Llandudno', N'County Durham', '20070914 16:09:21.400', N'Joshua.Scott@example.com')
INSERT INTO [dbo].[Contacts] ([ID], [ContactFullName], [PhoneWork], [PhoneMobile], [Address1], [Address2], [Address3], [JoiningDate], [Email]) VALUES (4, N'Daniel Powell', N'01659 216066', N'07272 134093', N'93 North Street', N'Newport', N'Cheshire', '20070914 16:09:21.417', N'Daniel.Powell@example.com')
INSERT INTO [dbo].[Contacts] ([ID], [ContactFullName], [PhoneWork], [PhoneMobile], [Address1], [Address2], [Address3], [JoiningDate], [Email]) VALUES (5, N'Jennifer Washington', N'01502 976179', N'07225 483640', N'43 The Grove', N'Hull', N'Berkshire', '20070914 16:09:21.430', N'Jennifer.Washington@example.com')
INSERT INTO [dbo].[Contacts] ([ID], [ContactFullName], [PhoneWork], [PhoneMobile], [Address1], [Address2], [Address3], [JoiningDate], [Email]) VALUES (6, N'Anthony Lee', N'01200 660059', N'07696 849723', N'97 Stanley Road', N'Newport', N'Berkshire', '20070914 16:09:21.430', N'Anthony.Lee@example.com')
...
SET @temp = RAND(1)
WHILE (@purchaseCount < 31415) BEGIN
	INSERT INTO [dbo].[WidgetPurchases] ([WidgetPriceID], [Quantity], [InvoiceNumber], [Date]) VALUES (
...
INSERT INTO [dbo].[WidgetPrices] ([RecordID], [WidgetID], [Price], [ValidFrom], [ValidTo], [Active]) VALUES (1, 1, 100, '2000-01-01 00:00:00.000', '2002-01-01 00:00:00.000', 'Y')
INSERT INTO [dbo].[WidgetPrices] ([RecordID], [WidgetID], [Price], [ValidFrom], [ValidTo], [Active]) VALUES (2, 2, 50, '2000-01-01 00:00:00.000', '2002-01-01 00:00:00.000', 'Y')
INSERT INTO [dbo].[WidgetPrices] ([RecordID], [WidgetID], [Price], [ValidFrom], [ValidTo], [Active]) VALUES (3, 4, 25, '2000-01-01 00:00:00.000', '2002-01-01 00:00:00.000', 'Y')
INSERT INTO [dbo].[WidgetPrices] ([RecordID], [WidgetID], [Price], [ValidFrom], [ValidTo], [Active]) VALUES (4, 1, 110, '2002-01-01 00:00:00.000', '2003-01-01 00:00:00.000', 'N')
INSERT INTO [dbo].[WidgetPrices] ([RecordID], [WidgetID], [Price], [ValidFrom], [ValidTo], [Active]) VALUES (5, 2, 55, '2002-01-01 00:00:00.000', '2003-01-01 00:00:00.000', 'N')
INSERT INTO [dbo].[WidgetPrices] ([RecordID], [WidgetID], [Price], [ValidFrom], [ValidTo], [Active]) VALUES (6, 4, 30, '2002-01-01 00:00:00.000', '2003-01-01 00:00:00.000', 'N')
/*
...
INSERT INTO [dbo].[WidgetDescriptions] ([WidgetID], [ShortDescription], [Description], [Picture]) VALUES (1, N'A widget', N'<description xmlns="http://www.red-gate.com/widgets/WidgetDescriptionSchema">
  <descriptiveText>A cunning widget</descriptiveText>
...
INSERT INTO [dbo].[WidgetDescriptions] ([WidgetID], [ShortDescription], [Description], [Picture]) VALUES (2, N'A medium-sized widget', N'<description xmlns="http://www.red-gate.com/widgets/WidgetDescriptionSchema">
  <descriptiveText>This is a medium-sized widget, ideally suited for the home and garden environment</descriptiveText>
